...
static nixlBackendEngine* create_uccl_engine(const nixlBackendInitParams* init_params) {
    return new nixlUcclEngine(init_params);
}

static void destroy_uccl_engine(nixlBackendEngine *engine) {
    delete engine;
}
...
nixlBackendPlugin* createStaticUcclPlugin() {
